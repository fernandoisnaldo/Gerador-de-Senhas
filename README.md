...
1) Uso da classe SecureRandom para gerar números aleatórios, garantindo segurança para fins criptográficos.
2) Nenhuma String ou StringBuilder é utilizada para acumular caracteres. (isso é mais uma curiosidade técnica do que uma utilidade prática)
