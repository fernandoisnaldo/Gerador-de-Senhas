...
2) Nenhuma String, StringBuilder ou array de tipo primitivo é utilizado para acumular caracteres. Os valores são impressos diretamente, de forma homogênea e se aplicável, com offsets para caracteres imprimíveis da tabela ASCII.
