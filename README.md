...
2) Nenhuma String, StringBuilder ou array de tipo primtivo é utilizado para acumular caracteres, os valores são impressos diretamente, os valores são impressos diretamente, de forma homogênea e se aplicável, com offsets para caracteres imprimíveis da tabela ASCII.
